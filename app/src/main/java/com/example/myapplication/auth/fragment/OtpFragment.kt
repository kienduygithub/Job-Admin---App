...
private const val TAG = "OtpFragmentTag";
...
//            }
    ...
    private fun createLoginText(): SpannableString {
        ...
        loginText.setSpan(UnderlineSpan(), 17, loginText.length, 0)
        loginText.setSpan(loginColor, 17, loginText.length, Spannable.SPAN_INCLUSIVE_INCLUSIVE)
        return loginText
    }
